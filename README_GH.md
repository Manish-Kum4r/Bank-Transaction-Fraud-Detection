...
Power BI → Interactive dashboards, ROI calculators, fraud vs genuine visuals
...
Interactive Slicers → Date, Customer ID, Location, Fraud Flag for drill‑down analysis

Professional Theme → Light grey dashboard background, white visuals, corporate blue/teal accents
...
Showcases skills in data visualization, statistical analysis, and dashboard design aligned with industry standards
...
Power BI → Open fraud_dashboard.pbix to view interactive dashboard.

Dataset → Use bank_transactions.csv as input data.
...
Applying fraud detection logic and visual storytelling

Delivering recruiter‑friendly project documentation and repo structure
